    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <ul class="navbar-nav">
            <li class="nav-item active">
                <a class="nav-link" href="#">List Phim</a>
            </li>
            <li class="nav-item">
...
<div class="container">
    <table class="table" style="margin-top: 10px;">
        ...
        <tbody>
            <?php include "../controller/GetListFilm.php";?>
        </tbody>
    </table>
</div>
    ...
    $('#btn_delete_phim').click(function () {
        ...
        if(atLeastOneIsChecked.length ===0){
           ...
           return false;
            ...
            var conf = confirm("Bạn có muốn xóa phim đã chọn ?");
            if(conf){
                var i=0;
        ...
        window.location.href ="../controller/DeleteListPhim.php?id="+id_phim;
    });
</script>